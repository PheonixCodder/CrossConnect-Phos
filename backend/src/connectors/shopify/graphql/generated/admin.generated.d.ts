    ...
    webhookSubscription?: AdminTypes.Maybe<
      Pick<AdminTypes.WebhookSubscription, 'id' | 'topic'> & {
        endpoint:
          ...
          | ({ __typename: 'WebhookHttpEndpoint' } & Pick<
              AdminTypes.WebhookHttpEndpoint,
              'callbackUrl'
            >);
      }
    >;
...
export type DeleteWebhookMutation = {
  webhookSubscriptionDelete?: AdminTypes.Maybe<
    Pick<
      AdminTypes.WebhookSubscriptionDeletePayload,
...
export type FetchFulfillmentsQuery = {
  orders: {
    nodes: Array<
            ...
            fulfillmentLineItems: {
              nodes: Array<
                Pick<AdminTypes.FulfillmentLineItem, 'id' | 'quantity'> & {
                  lineItem: Pick<AdminTypes.LineItem, 'id' | 'sku'> & {
...
export type FetchInventoryLevelsQuery = {
  inventoryItems: {
    nodes: Array<
        ...
        inventoryLevels: {
          nodes: Array<
            Pick<AdminTypes.InventoryLevel, 'id' | 'updatedAt'> & {
              ...
              >;
              location: Pick<AdminTypes.Location, 'id' | 'name'>;
            }
          >;
        };
      }
...
export type FetchReturnsQuery = {
  orders: {
    edges: Array<{
      node: Pick<AdminTypes.Order, 'id' | 'currencyCode' | 'updatedAt'> & {
        returns: {
          nodes: Array<Pick<AdminTypes.Return, 'id' | 'status' | 'createdAt'>>;
        };
        refunds: Array<{
          totalRefundedSet: { shopMoney: Pick<AdminTypes.MoneyV2, 'amount'> };
        }>;
      };
    }>;
    pageInfo: Pick<AdminTypes.PageInfo, 'hasNextPage' | 'endCursor'>;
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query FetchFulfillments($after: String, $since: String) {\n  orders(first: 250, after: $after, query: $since) {\n    nodes {\n      id\n      updatedAt\n      fulfillments {\n        id\n        status\n        updatedAt\n        trackingInfo {\n          company\n          number\n          url\n        }\n        # ADD THIS BLOCK\n        fulfillmentLineItems(first: 100) {\n          nodes {\n            id\n            quantity\n            lineItem {\n              id\n              sku\n              product { id }\n            }\n          }\n        }\n      }\n    }\n      pageInfo {\n        hasNextPage\n        endCursor\n      }\n  }\n}\n': {
    return: FetchFulfillmentsQuery;
    variables: FetchFulfillmentsQueryVariables;
  };
  '#graphql\n  query FetchInventoryLevels($after: String, $since: String) {\n    # Fix: Use inventoryItems to fetch a list of items and their levels\n    inventoryItems(    first: 250\n    after: $after\n    query: $since\n) {\n      nodes {\n        id\n        sku\n        updatedAt\n        inventoryLevels(first: 50) {\n          nodes {\n            id\n            updatedAt\n            quantities(names: ["available", "on_hand"]) {\n              name\n              quantity\n            }\n            location {\n              id\n              name\n            }\n          }\n        }\n      }\n        pageInfo {\n        hasNextPage\n        endCursor\n      }\n    }\n  }\n': {
    return: FetchInventoryLevelsQuery;
    variables: FetchInventoryLevelsQueryVariables;
  };
  '#graphql\n  query FetchOrders($after: String, $since: String) {\n    orders(first: 250, after: $after, query: $since) {\n      nodes {\n        id\n        updatedAt\n        createdAt\n        createdAt\n        currencyCode\n        canMarkAsPaid\n        cancelReason\n        subtotalPriceSet {\n          shopMoney {\n            amount\n            currencyCode\n          }\n        }\n        totalTaxSet {\n          shopMoney {\n            amount\n            currencyCode\n          }\n        }\n        totalPriceSet {\n          shopMoney {\n            amount\n            currencyCode\n          }\n        }\n        lineItems(first: 250) {\n          nodes {\n            id\n            sku\n            quantity\n            originalUnitPrice\n            discountedUnitPrice\n            originalUnitPriceSet {\n              shopMoney {\n                amount\n                currencyCode\n              }\n            }\n            discountedTotalSet {\n              shopMoney {\n                amount\n                currencyCode\n              }\n            }\n            product {\n              id\n              priceRange {\n                maxVariantPrice {\n                  amount\n                }\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: FetchOrdersQuery;
