...
- A NestJS backend that manages connectors, background jobs, webhooks, and persistence.
- A NextJS frontend that provides a multi-channel dashboard and management UI.
